...
census_api_key("7758d4e5187c42d4eb242f91cc1aee470fb79810")
...
## define paths
input_path <- "C:/Users/clint/Desktop/nzlud/other_data/processed/"
output_path <- "C:/Users/clint/Desktop/nzlud/other_data/processed/"
...
b10.msa.large.wrld%>%
  select(cbsaname10,responses,WRLURI18_st)%>%
  View
##################################
...
iz.msas.large.nzlu%>%
  select(cbsaname10,responses,zri_full_st)%>%
  View
